// Generated from d:/Users/EC/Desktop/PMF/3rd year/Kompilatori/KK Projekat/antlr/CppLexer.g4 by ANTLR 4.13.1
...
public class CppLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"CLASS", "PUBLIC", "PRIVATE", "VOID", "INT", "FLOAT", "DOUBLE", "CHAR", 
			"BOOL", "STRING", "STD", "RETURN", "NEW", "IF", "ELSE", "WHILE", "INCLUDE", 
			"LBRACE", "RBRACE", "LPAREN", "RPAREN", "SEMI", "COMMA", "DOT", "ASSIGN", 
			"PLUS", "MINUS", "STAR", "DIV", "QUOTE", "COLON", "COLONCOLON", "LEFT_SHIFT", 
			"RIGHT_SHIFT", "LT", "GT", "ID", "NUMBER", "STRING_LITERAL", "LINE_COMMENT", 
			"BLOCK_COMMENT", "WS"
		};
	}
